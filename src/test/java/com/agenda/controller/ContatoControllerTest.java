...
import com.agenda.adapters.controller.ContatoController;
...
public class ContatoControllerTest {
        ...
        void deveRetornar201AoCriarContato() throws Exception {
                var request = new ContatoRequest("Joao Silva", "99-99999-999", "joao@email.com",
        ...
        void deveRetornar400ParaNomeEmBranco() throws Exception {
                var request = new ContatoRequest("", "99-99999-999", "joao@email.com",
                                "", 20, TipoContato.AMIGO, Status.ATIVO);
        ...
        void deveRetornar400ParaEmailInvalido() throws Exception {
                var request = new ContatoRequest("Joao Silva", "99-99999-999",
                                "nao-e-email",
                                "", 20, TipoContato.AMIGO, Status.ATIVO);
